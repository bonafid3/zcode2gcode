...
#ifdef Q_OS_MAC //utils.h a MAC macroval egyutt egyeb utkozeseket is magaval hoz
    uint crc_32 = crc32(0, 0, 0);
    crc_32 = crc32(crc_32, (const uchar *)contents.constData(), contents.length());
#else
    uint crc_32 = ::z_crc32(0, 0, 0);
    crc_32 = ::z_crc32(crc_32, (const uchar *)contents.constData(), contents.length());
#endif
